...
//        customerService.insertWithStoredProcedure(customer);
        customerService.saveByJpaRepository(customer);
        ModelAndView modelAndView = new ModelAndView("/customer/create");
        modelAndView.addObject("customer", new Customer());
    ...
    @GetMapping("/customers-by-firstname/{firstName}")
    public ModelAndView listCustomersByFirstName(@PathVariable String firstName) {
