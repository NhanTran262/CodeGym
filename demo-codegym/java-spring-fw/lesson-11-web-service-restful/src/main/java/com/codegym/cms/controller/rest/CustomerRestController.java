package com.codegym.cms.controller.rest;
...
public class CustomerRestController {
    ...
    public ResponseEntity<?> findAllCustomersDtoWithModelMapper() {
        List<CustomerListDto> customers = customerService.findCustomersWithModelMapper();
    ...
    @GetMapping("/list-dto-with-bean-utils")
    public ResponseEntity<?> findAllCustomersDtoWithBeanUtils() {
        List<CustomerListDto> customers = customerService.findCustomersWithBeanUtils();
        if (customers.isEmpty()) {
            return new ResponseEntity<>(HttpStatus.NO_CONTENT);
        }
        return new ResponseEntity<>(customers, HttpStatus.OK);
    ...
    public ResponseEntity<Customer> findCustomerById(@PathVariable Long id) {
        ...
        return (!customerOptional.isPresent())
                ...
                : new ResponseEntity<>(customerOptional.get(), HttpStatus.OK);
    }
